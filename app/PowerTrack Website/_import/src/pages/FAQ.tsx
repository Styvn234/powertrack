      ...
      <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="space-y-4">
          ...
          <motion.div
            ...
            className={`bg-powertrack-surface border rounded-2xl overflow-hidden transition-colors ${openIndex === i ? 'border-powertrack-accent-teal/50' : 'border-powertrack-border'}`}>
              ...
              className="w-full px-6 py-6 flex items-center justify-between text-left focus:outline-none">
                ...
                <span
                className={`font-bold text-lg pr-8 transition-colors ${openIndex === i ? 'text-powertrack-text' : 'text-powertrack-text-secondary'}`}>
                
                  {faq.q}
                </span>
                <div
                className={`shrink-0 w-8 h-8 rounded-full flex items-center justify-center transition-colors border ${openIndex === i ? 'bg-powertrack-accent-teal/10 border-powertrack-accent-teal/30 text-powertrack-accent-teal' : 'bg-powertrack-surface-elevated border-powertrack-border text-powertrack-muted'}`}>
