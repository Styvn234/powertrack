            ...
            {links.map((link) => {
              ...
              return (
                <Link
                  key={link.path}
                  to={link.path}
                  className={`relative text-sm font-medium transition-colors hover:text-powertrack-text ${isActive ? 'text-powertrack-text' : 'text-powertrack-muted'}`}>
        ...
        <motion.div
          ...
          className="md:hidden border-t border-powertrack-border bg-powertrack-surface overflow-hidden">
            ...
            <Link
              ...
              className={`block rounded-md px-3 py-3 text-base font-medium ${location.pathname === link.path ? 'bg-powertrack-surface-elevated text-powertrack-accent-teal' : 'text-powertrack-muted hover:bg-powertrack-surface-elevated hover:text-powertrack-text'}`}>
