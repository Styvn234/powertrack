          ...
          <div className="grid grid-cols-4 gap-3">
            <div className="bg-powertrack-surface p-3 rounded-lg border border-powertrack-border">
              ...
              <div className="text-lg font-bold text-powertrack-text">
                3.2 <span className="text-powertrack-accent-teal text-xs">kW</span>
              </div>
            </div>
            <div className="bg-powertrack-surface p-3 rounded-lg border border-powertrack-border">
              <div className="text-[9px] uppercase font-bold tracking-widest text-powertrack-muted mb-1">
              ...
              <div className="text-lg font-bold text-powertrack-text">
                24.5
                <span className="text-powertrack-accent-green text-xs"> kWh</span>
              </div>
            </div>
            <div className="bg-powertrack-surface p-3 rounded-lg border border-powertrack-border">
              <div className="text-[9px] uppercase font-bold tracking-widest text-powertrack-muted mb-1">
              ...
              <div className="text-lg font-bold text-powertrack-text">
                $4.12
                <span className="text-powertrack-accent-amber text-xs"> USD</span>
              </div>
            </div>
            <div className="bg-powertrack-surface p-3 rounded-lg border border-powertrack-border">
              <div className="text-[9px] uppercase font-bold tracking-widest text-powertrack-muted mb-1">
              ...
              <div className="text-lg font-bold text-powertrack-text">
                5.2
                <span className="text-powertrack-accent-magenta text-xs"> kW</span>
              </div>
            </div>
          </div>
        ...
        <div className="relative flex-1 p-5 flex flex-col justify-between overflow-hidden">
          ...
          <div className="relative z-10 flex justify-between items-start">
            ...
            <div className="flex flex-col items-end gap-1">
              ...
              <div className="w-8 h-2 bg-[#1F2A3D] rounded-sm"></div>
              <Wifi size={14} className="text-powertrack-accent-teal mt-2 animate-pulse" />
            </div>
          </div>
